...
std::vector<std::vector<int>> mat_multiplication(
...
std::vector<std::vector<int>> tr_mat_multiplication(
    const std::vector<std::vector<int>> &a,
    const std::vector<std::vector<int>> &b) {
    std::vector<std::vector<int>> c(a.size(), std::vector<int>(b[0].size(), 0));
...
std::vector<std::vector<int>> transpose_matrix(
    ...
    std::vector<std::vector<int>> tr_mat(mat[0].size(),
...
int main() {
    ...
    std::cout << "First method finished, elapsed time: "
    ...
    std::cout << "Second method finished, elapsed time: "
              << elapsed_seconds.count() << "s\n";
