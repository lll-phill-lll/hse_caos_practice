1. **Github messenger** [необычное использование приввычных технологий]. Сделать мессенджер, с помощью которого можно переписываться использую гитхаб. Локально это выглядит как мессенджер (в терминале или нет).
