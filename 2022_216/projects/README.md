...
4. **2 апреля** - необходимо отписаться (3 - 4 предложения) о текущем статусе проекта, предоставить какой-то код (может быть не в финальном состоянии). Показать, что работа какая-то идет.
